...
const DynamicNewItemComponent: React.FC<{ col: ColsOrder, taskCol: Col, updateTask: (col: Col) => void, id: string, onCelClick: (el: HTMLSpanElement, taskCol: Col) => void }> = ({ col, taskCol, updateTask, onCelClick }) => {
...
export default DynamicNewItemComponent